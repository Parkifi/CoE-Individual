...
// in simulator we redefine to format for MeuArraial Developer console
...
{\
	NSString * exceptionName = [@"org.meuarraial." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.meuarraial";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIMeuArraialNativeItemNone = -1, 
	UIMeuArraialNativeItemSpinner = -2,
	UIMeuArraialNativeItemProgressBar = -3,
	
	UIMeuArraialNativeItemSlider = -4,
	UIMeuArraialNativeItemSwitch = -5,
	UIMeuArraialNativeItemMultiButton = -6,
	UIMeuArraialNativeItemSegmented = -7,
	
	UIMeuArraialNativeItemTextView = -8,
	UIMeuArraialNativeItemTextField = -9,
	UIMeuArraialNativeItemSearchBar = -10,
	
	UIMeuArraialNativeItemPicker = -11,
	UIMeuArraialNativeItemDatePicker = -12,
	
	UIMeuArraialNativeItemInfoLight = -13,
	UIMeuArraialNativeItemInfoDark = -14,
	
	UIMeuArraialNativeItemDisclosure = -15,
	
	UIMeuArraialNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all MeuArraial instances of
