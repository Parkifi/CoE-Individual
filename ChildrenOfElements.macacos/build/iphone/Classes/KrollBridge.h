...
@interface MeuArraialObject : KrollCoverageObject {
#else
@interface MeuArraialObject : KrollObject {
#endif
@private
...
extern NSString * MeuArraial$ModuleRequireFormat;
