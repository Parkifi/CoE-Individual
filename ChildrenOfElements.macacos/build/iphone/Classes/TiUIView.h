...
/**
 Base class for all MeuArraial views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the MeuArraial view hierarchy (such as wrapped iOS UIViews) was touched.
