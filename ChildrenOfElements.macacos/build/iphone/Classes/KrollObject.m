...
//@interface MeuArraialObject : NSObject
//@end

@interface MeuArraialObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[MeuArraialObject class]])
		{
			for (NSString *key in [[(MeuArraialObject*)o modules] allKeys])
			{
